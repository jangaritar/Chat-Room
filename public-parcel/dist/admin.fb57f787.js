...
})({"hoyON":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "df80b4a3fb57f787";
"use strict";
...
},{}],"lMFI2":[function(require,module,exports,__globalThis) {
const admin = 'Jose';
const username = prompt('Nombre de usuario Administrador:', ' ');
if (username === admin) {
    const password1 = 'Jose';
    const password = prompt("Si quieres administrar, necesitas una contrase\xf1a. Por favor, colocala ahora:", ' ');
    if (password === password1) alert("Bienvenido");
    else {
        alert("Contrase\xf1a incorrecta. Ser\xe1 enviado a la sala de inicio.");
        window.location = "index.html";
    }
} else {
    alert("Usuario incorrecto. Ser\xe1 enviado a la sala de inicio.");
    window.location = "index.html";
}
document.addEventListener('DOMContentLoaded', ()=>{
    /** Obtaininga and rendering User List in JSON */ const socket = io('https://' + location.hostname + ':5500');
    ...
    /** Emiting new Stream */ const streamSender = document.getElementById('stream-sender');
    ...
    streamSender.addEventListener('submit', (e)=>{
        ...
        streamInput.value = '';
        alert("Su nuevo stream se est\xe1 emitiendo.");
    });
    /** Emiting new RIFA number */ const rifaForm = document.getElementById('rifa-form');
    ...
    rifaForm.addEventListener('submit', (e)=>{
        ...
        rifaInput.value = '';
        alert("Su nueva rifa se est\xe1 emitiendo.");
    });
    let rifaWinner = '';
...
},{}]},["hoyON","lMFI2"], "lMFI2", "parcelRequire94c2")

//# sourceMappingURL=admin.fb57f787.js.map
